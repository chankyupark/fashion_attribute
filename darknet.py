...
class DetectionLayer(nn.Module):
    ...
    def forward(self, x, inp_dim, num_classes, confidence):
        ...
        global CUDA
        prediction = x
        prediction = predict_transform(prediction, inp_dim, self.anchors, num_classes, confidence, device)
        return prediction
...
#            upsample = Upsample(stride)
        ...
        #    upsample = nn.functional.interpolate(None, scale_factor = 2, mode = "nearest")
